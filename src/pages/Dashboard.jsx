  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Obtener ventas de hoy y este mes
        ...
        setSalesData(report.ventas.slice(0, 5)); // Últimas 5 ventas
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
          <div className="p-6 flex items-center">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-600 mb-1">Ventas Hoy</h2>
              <p className="text-2xl font-bold text-gray-800">{formatCurrency(todaySales)}</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
          <div className="p-6 flex items-center">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-600 mb-1">Ventas Mes</h2>
              <p className="text-2xl font-bold text-gray-800">{formatCurrency(monthSales)}</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
          <div className="p-6 flex items-center">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-600 mb-1">Total Productos</h2>
        ...
        <Card className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
          <div className="p-6 flex items-center">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-600 mb-1">Bajo Stock</h2>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {salesData.map((sale, index) => (
                    <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      <td className="px-4 py-3 text-sm font-medium text-gray-900">{sale._id.substring(0, 8)}...</td>
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-lg text-gray-800">{formatCurrency(monthSales)}</span>
              </div>
              <div className="flex justify-between items-center">
